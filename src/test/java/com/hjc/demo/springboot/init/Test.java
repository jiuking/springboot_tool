...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        FetchCustBaseInfoDto.ContactInfoDto a = new  FetchCustBaseInfoDto.ContactInfoDto();
        a.setContactMobile("124");
        a.setContactTel("34");
        List<FetchCustBaseInfoDto.ContactInfoDto> contactInfoDtoList = new ArrayList<>();
        contactInfoDtoList.add(a);
        p1.setContactInfoLists(contactInfoDtoList);
        set.add(p1);
        listP.add(set);
